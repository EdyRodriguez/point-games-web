...
function Hero() {
  ...
  <iframe src="https://player.twitch.tv/?channel=edycony&parent=https://point-games-web.vercel.app/&muted=true" autoPlay={true} allowFullScreen={true}  scrolling="no" height="480" width="720"></iframe>
